...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-[#1A1F2C] to-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="pixel-card">
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="pixel-button w-full font-pixel text-sm py-3 flex items-center justify-center group">
