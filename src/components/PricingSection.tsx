      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="plan-card basic relative overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="font-bold mb-2 text-pixel-green font-pixel text-lg text-center">LANDING PAGE</h3>
          ...
          <div className="plan-card standard relative overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="font-bold mb-2 text-pixel-yellow font-pixel text-base text-center">LANDING PAGE + ADMIN</h3>
          ...
          <div className="plan-card premium relative overflow-hidden">
            ...
            <div className="p-6">
              <h3 className="font-bold mb-2 text-pixel-red font-pixel text-lg text-center">WEBSITE + ADMIN</h3>
